...
class _DesignerHomePageState extends State<DesignerHomePage> {
  final  HomeWidgPage  a= HomeWidgPage(); // Instance of WidgetHome
 ...
 final FirebaseAuth _auth = FirebaseAuth.instance;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: a.buildAppBar(context), // Use widgetHome to call AppBar
      drawer: buildDrawer(),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            Expanded(child: a.buildProductGrid(selectedCategory)), // Show products based on category
          ],
        ),
      ),
    );
          ...
          Container(
            ...
            child: StreamBuilder<DocumentSnapshot>(
              stream: FirebaseFirestore.instance
                  .collection('designeregistration') // Correct collection name
