  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: const Text(
          '''Terms & Conditions
These terms and conditions apply to the app (hereby referred to as "Application") for mobile devices that was created by (hereby referred to as "Service Provider") as a Free service.
...
These terms and conditions are effective as of 2024-09-07
